...
[ -z "${warmup_updates}" ] && warmup_updates="250" # 25000
[ -z "${tot_updates}" ] && tot_updates="1000" # 400000
...
save_path_train="../../exps/abcd-func/$exp_name-$warmup_updates-$tot_updates/$seed"
