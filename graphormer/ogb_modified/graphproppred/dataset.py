...
from ogb_modified.utils.url import decide_download, download_url, extract_zip
from ogb_modified.io.read_graph_raw import read_csv_graph_raw, read_binary_graph_raw
import torch
    ...
    def pre_process(self):
        ...
        if os.path.exists(pre_processed_file_path):
            ...
            if self.binary:
                ...
                # csv file
                has_necessary_file = osp.exists(osp.join(self.root, 'raw', 'edge.csv.gz')) # it exists!
...
if __name__ == '__main__':
    dataset = GraphPropPredDataset(name = 'abcd-struct')
